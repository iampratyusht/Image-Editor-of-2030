...
# timm (use the newer timm.layers and timm.models imports)
import warnings
...
def register_tiny_vit_model(fn):
    ...
    # Suppress warning about overwriting existing model names in registry
    with warnings.catch_warnings():
...
#######################################
# Transformer Decoder for Mask Decoder
#######################################
